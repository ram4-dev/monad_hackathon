...
### 1. [x] Extend types and SafeError
...
### 2. [x] On-chain policy resolution (consume W3)
...
### 3. [x] Required-evidence + simulation orchestration
...
### 4. [x] Canonical digest + idempotency
...
### 5. [x] LLM final safety review (veto-only, fail-closed)
...
### 6. [x] Wire the full interceptor + audit
...
### 8. [x] Apply progress + verify report
